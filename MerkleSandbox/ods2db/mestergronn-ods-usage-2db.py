...
# Set script name
script_name = 'mestergronn-ods-usage-2db'
...
for i in sandbox_list['data']:
    ...
    if realm == 'bfmt':  # Smenyash ID-to mezhdu kavichkite s tova na klienta, koito iskash da reportvash. ID-to se vzima ot https://wiki.isobarsystems.com/display/SUPTEAM/Local+POD+time+-+Notifications
        ...
        log_and_print(f'Fifth request endpoint answer is {sandbox_usage_on_realm_bfmt_since2021_01_01}')
        ...
        list2fill.append(credits_spent_on_realm_bfmt)
...
try:
    ...
    sql = 'INSERT INTO MestergronnODSUsage(TimeStamp, SandboxID, Realm, Instance, State, CreatedAt, CreatedBy, MinutesUpSinceCreated, MinutesDownSinceCreated, TotalCredits, MinutesUpInLast24Hours, MinutesDownInLast24Hours, ThisODSCreditsSince01012021, TotalCreditsInRealmSince01012021) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)'
