...
# Set script name
script_name = 'asda-web04-ods-usage-report'
...
for i in sandbox_list['data']:
    ...
    if realm == 'aakr':  # Smenyash ID-to mezhdu kavichkite s tova na klienta, koito iskash da reportvash. ID-to se vzima ot https://wiki.isobarsystems.com/display/SUPTEAM/Local+POD+time+-+Notifications
        ...
        credits_spent_on_realm_aakr = minutes_up + (minutes_down * 0.3)
        ...
        logger.debug(f'Fourth request endpoint answer is {sandbox_usage_on_realm_aakr_since2021_03_01}')
...
logger.debug(f'Fifth request endpoint answer is {sandbox_usage_on_realm_aakr_since2021_03_01}')

realm_aakr_minutes_up210301 = sandbox_usage_on_realm_aakr_since2021_03_01['data']['minutesUp']
realm_aakr_minutes_down210301 = sandbox_usage_on_realm_aakr_since2021_03_01['data']['minutesDown']
credits_spent_on_realm_aakr = realm_aakr_minutes_up210301 + (realm_aakr_minutes_down210301 * 0.3)
log_and_print(credits_spent_on_realm_aakr)
...
last_dataframe_row = {'SandboxID': '', 'Realm': '', 'Instance': '', 'State': '', 'Created at': '', 'Created by': '',
                      ...
                      'Credits since 01.03.2021': credits_spent_on_realm_aakr}
...
emailText = f'Hi Team. My name is {script_name}. Please check the overview for today. Keep in mind that living sandboxes on demand are spending credits. Each minute uptime = 1 credit. And each minute down time = 0.3 credit. If you have any questions, please do not hesitate to contact Merkle Operations Support.'

email_recipient = const.support_email
email_subject = 'ASDA Web04 ODS update for today'
