...
from projects_config import PROJECT_KEYS, PROJECT_NAMES  # Project configurations
from my_logger import configure_logger  # Custom logger configuration
...
if __name__ == "__main__":
    ...
    if project_issues_dfs is not None and total_issues_df is not None and customfield_dfs is not None and combined_dfs is not None and low_rated_issues_df is not None:
        # Specify the path to save the Excel file
        excel_output_path = 'MonthlyRating.xlsx'
