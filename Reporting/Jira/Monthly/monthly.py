...
from projects_config import PROJECT_NAMES
...
class IssueDataFetcher:
    ...
    def fetch_created_issues():
        ...
        try:
            ...
            print(f"Failed to execute the report generation for Created issues: {e}")  # Log error
    ...
    def fetch_resolved_issues():
        ...
        try:
            ...
            print(f"An error occurred in the main execution: {e}")  # Log error
    ...
    def fetch_closed_issues():
        ...
        try:
            ...
            if project_issues_dfs is not None and total_issues_df is not None:
                ...
                print("Failed to retrieve the reports.")  # Log warning
                return {}, pd.DataFrame()  # Return empty data on failure
        except Exception as e:
            print(f"Failed to fetch closed issues: {e}")  # Log error
            return {}, pd.DataFrame()  # Return empty data on failure
...
class DataFrameMerger:
    ...
    def merge_dataframes(project_dfs_created, project_dfs_resolved, project_dfs_closed, total_df_created,
        ...
        try:
            ...
            print(f"Error occurred while merging dataframes: {e}")  # Log error
            return {}, pd.DataFrame()  # Return empty data on failure
...
class ExcelReportGenerator:
    ...
    def save_to_excel(self, merged_project_dfs, total_merged_df):
        ...
        try:
            ...
            print(f"Failed to save report to Excel: File not found error - {fnf_error}")  # Log file not found error
        except PermissionError as perm_error:
            print(f"Failed to save report to Excel: Permission error - {perm_error}")  # Log permission error
        except pd.errors.EmptyDataError as empty_data_error:
            print(f"Failed to save report to Excel: Empty data error - {empty_data_error}")  # Log empty data error
        except Exception as e:
            print(f"Failed to save report to Excel: {e}")  # Log any other exceptions
    ...
    def _save_total_dataframe(self, writer, total_merged_df, execution_date, execution_month):
        ...
        # Reverse the dataframe by month from oldest to newest before saving
        total_merged_df = total_merged_df.sort_values(by='Month')
