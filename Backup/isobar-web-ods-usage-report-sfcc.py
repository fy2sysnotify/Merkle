...
# Set script name
scriptName = 'isobar-web-ods-usage-report'
...
for i in sandboxList['data']:
    ...
    if realm == 'aaay':  # Smenyash ID-to mezhdu kavichkite s tova na klienta, koito iskash da reportvash. ID-to se vzima ot https://wiki.isobarsystems.com/display/SUPTEAM/Local+POD+time+-+Notifications
        ...
        creditsSpentOnRealmAaay = minutesUp + (minutesDown * 0.3)
        ...
        logger.debug(f'Fourth request endpoint answer is {sandboxUsageOnRealmAaaySince2021_03_01}')
...
realmAaayMinutesDown210301 = sandboxUsageOnRealmAaaySince2021_03_01['data']['minutesDown']
creditsSpentOnRealmAaay = realmAaayMinutesUp210301 + (realmAaayMinutesDown210301 * 0.3)
log_and_print(creditsSpentOnRealmAaay)
...
lastDataframeRow = {'SandboxID': '', 'Realm': '', 'Instance': '', 'State': '', 'Created at': '', 'Created by': '', 'Minutes up since created': '', 'Minutes down since created': '', 'Total credits': '', 'Minutes up in last 24 hours': '', 'Minutes down in last 24 hours': '', 'Credits since 01.03.2021': creditsSpentOnRealmAaay}
